"""
Data Models & Telemetry Definitions for SquiggleCaller: CTC Connectionist Temporal Classification Basecaller.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Oxford Nanopore Raw Data Standards"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
