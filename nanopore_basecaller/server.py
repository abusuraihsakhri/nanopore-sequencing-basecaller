"""
FastAPI REST API Server for SquiggleCaller: CTC Connectionist Temporal Classification Basecaller.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="SquiggleCaller: CTC Connectionist Temporal Classification Basecaller",
            description="Decodes raw ionic current squiggles into A/C/G/T nucleotides using CTC beam search decoding and dynamic time warping.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "nanopore-sequencing-basecaller", "domain": "Bioinformatics", "version": "2.0.0-FRONTIER"}
