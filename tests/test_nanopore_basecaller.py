...
import pytest
from nanopore_basecaller.models import FrontierPayload, ExecutionStatus
from nanopore_basecaller.engine import FrontierDomainEngine
from nanopore_basecaller.agents import RawCurrentNormalizerAgent, CTCBeamSearchDecoderAgent, PhredQualityScorerAgent, SquiggleBasecallerCoordinator
from nanopore_basecaller.cli import main


def test_sub_agents():
    a1 = RawCurrentNormalizerAgent()
...
def test_coordinator():
    coord = SquiggleBasecallerCoordinator()
    ...
    assert "Oxford Nanopore Raw Data Standards" in ans or "specifications" in ans
