"""
Live WebSocket Distributed Component Telemetry Streamer for nanopore-sequencing-basecaller.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "nanopore-sequencing-basecaller", "event_type": event_type, "payload": data})
